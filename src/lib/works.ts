...
export const works: Work[] = [
  {
    ...
    image:
      "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781506833/homeapge-_gaine_rspb0f.png",
    ...
    segments: [
      {
        ...
        body: "The project balances rich visual imagery with narrative depth, creating a cohesive experience where images and storytelling work together to explore the cultural heritage of the Gandharva community.",
      ...
      },
      {
        ...
        body: "At the heart of the experience lies an interactive Sarangi element that emulates the authentic sound of traditional strings. This feature transforms the website into an instrument, inviting visitors to actively engage with the musical traditions central to Gandharva culture.",
        image:
          "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781506836/sarangi_interactive_eywabg.png",
    ...
    segments: [
      {
        ...
        body: "A short documentary production for OYU Green exploring the greening initiatives in Assam. The film documents the environmental restoration efforts and community engagement in the region.",
        image:
          "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781506694/Photo_Apr_22_2024_aq034e.jpg",
        imageCaption:
          "Greening India initiative, an Assam-based short documentary production for OYU Green",
      },
      {
        title: "Community Engagement",
        body: "Working directly with local communities to document their environmental restoration efforts and the stories behind them. These moments capture the dedication and commitment of volunteers on the ground.",
        image:
          "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781506694/Photo_Apr_22_2024_1_aftyig.jpg",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781511145/Photo_Jul_24_2023_rlhfyr.jpg",
    overview:
    ...
    segments: [
      {
        title: "PODS by PEI",
        body: "As Podcast Producer and Editor for PODS by PEI, I managed studio operations to ensure high-quality audio production. My work included recording sessions, sound design, editing episodes, and publishing them across digital platforms.\n\nBeyond production, I also hosted selected episodes that explored the relationship between technology and society. This experience helped me understand podcasting as both a technical and conversational medium.",
        image:
          "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781511148/Photo_Aug_3_2023_pn35xn.jpg",
      ...
      },
      {
        ...
        body: "I worked on the video podcast Blockchain Socialist, exploring the political and social dimensions of technology. My role included video editing, thumbnail design, and shaping the narrative structure of each episode to ensure that complex discussions were communicated clearly and effectively.",
      ...
      },
      {
        ...
        body: "Governance Futures focused on policy, governance, and emerging technologies. I was responsible for the video production and editorial flow, helping translate academic and policy-heavy discussions into engaging video content.",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781507822/Nepal_Paper_Cover_Ideas_vrbelu.png",
  ...
  },
  {
    ...
    year: "2021 — present",
    description:
      "Identity projects exploring place, trust, and the stories that shape organizations.",
    image:
      "https://res.cloudinary.com/dj7hwtgxy/image/upload/v1781507293/TLA_Brand_Guidelines_rj5mkn.png",
    overview:
    ...
    segments: [
      {
        ...
        body: "Developed the logo and brand guidelines for a finance company. The visual identity was inspired by the landscape of Lake Como, combining natural imagery with a sense of stability and long-term growth. The logo was traced and refined to maintain a balance between elegance and financial credibility.",
      ...
      {
        title: "Bharosa",
        body: "Created the identity for a Nepali real estate company. The logo draws from the form of a home, reflecting ideas of trust and belonging. The colour palette was inspired by traditional Nepali terracotta bricks, using warm tones to create a sense of familiarity and comfort.",
